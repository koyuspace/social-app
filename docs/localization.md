...
We want the official koyu.space app to be supported in as many languages as possible. If you want to help us translate the app, please get involved on [Crowdin](https://bluesky.crowdin.com/u/projects/1) or open an issue on the [koyu.space app repo on GitHub](https://github.com/koyuspace/social-app).

## Tools

- We use Crowdin to manage translations.
  - koyu.space Crowdin: https://bluesky.crowdin.com/u/projects/1
...
You can request a new language be added to the project by clicking **Request New Language** on Crowdin or you can create a [GitHub issue](https://github.com/koyuspace/social-app/issues).
