    ...
    <View style={[a.flex_1]}>
      <Layout.Content ignoreTabletLayoutOffset>
        ...
        <View style={[a.gap_2xl, a.mx_lg, a.my_2xl]}>
          ...
          <View style={[a.gap_sm]}>
            <Button
              label={_(msg`Join koyu.space`)}
              onPress={onJoinPress}
              variant="solid"
              color="primary"
              size="large">
              <ButtonText style={[a.text_lg]}>
                <Trans>Join koyu.space</Trans>
              </ButtonText>
            </Button>
      ...
      <Prompt.Outer control={androidDialogControl}>
        <Prompt.TitleText>
          <Trans>Download koyu.space</Trans>
        </Prompt.TitleText>
        <Prompt.DescriptionText>
          <Trans>
            The experience is better in the app. Download koyu.space now and we'll
      ...
      <View style={[a.flex_1, a.px_lg, {marginTop: 250}]}>
        ...
        <View style={[a.gap_md, {zIndex: 2}]}>
          <Text
            ...
            Download koyu.space to get started!
          </Text>
